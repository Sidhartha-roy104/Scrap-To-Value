 ...
 * indiaLocations.ts
 * -----------------
 * Comprehensive dataset of Indian States, Union Territories, and their respective districts.
 * Designed for B2B supplier facility pickup locations across India.
 */
...
export const INDIAN_STATES_AND_UTS: StateData[] = [
  ...
  },
  {
    ...
    districts: [
      'Bilaspur', 'Chamba', 'Hamirpur', 'Kangra', 'Kinnaush', 'Kullu', 'Lahaul and Spiti',
...
export const INDIAN_STATE_NAMES = INDIAN_STATES_AND_UTS.map((s) => s.state);
...
/**
 * Formats structured location fields into a clean readable string.
 * Example: "Jeedimetla, Medchal-Malkajgiri, Telangana, India"
 */
